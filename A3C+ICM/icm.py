...
class ICM(nn.Module):
    def __init__(self, input_dims, n_actions=3, alpha=0.1, beta=0.2): # alpha is lambda from paper
        ...
        self.inverse = nn.Linear(288*2, 256) # Input is 2 feature representations phi concatenated
        self.pi_logits = nn.Linear(256, n_actions)

        self.dense1 = nn.Linear(288+1, 256) # Input is feature representation and action
    ...
    def calc_loss(self, states, new_states, actions):
        # Don't need [] because these are already lists of states
