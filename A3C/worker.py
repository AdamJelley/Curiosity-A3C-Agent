...
def worker(name, input_shape, n_actions, global_agent, optimizer, env_id, n_threads, global_idx):
    ...
    while episode < max_eps:
        ...
        if name == '1':
            ...
            print('A3C episode {} thread {} of {} steps {:.2f}M score {:.2f} avg score (100) {:.2f}'.format(episode, name, n_threads, t_steps/1e6, score, avg_score))
    if name == '1':
        x = list(range(episode))
        plot_learning_curve(scores, x, 'A3C_pong_final.png')